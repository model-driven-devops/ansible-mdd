...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
        if PYNETBOX_LIBRARY_IMPORT_ERROR:
            raise AnsibleError("pynetbox must be installed to use this plugin") from PYNETBOX_LIBRARY_IMPORT_ERROR

        if REQUESTS_LIBRARY_IMPORT_ERROR:
            raise AnsibleError("requests must be installed to use this plugin") from REQUESTS_LIBRARY_IMPORT_ERROR
