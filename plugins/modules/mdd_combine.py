...
def get_merge_key(path, list_key_map=None):
    if list_key_map is None:
        list_key_map = {
            ...
            'mdd:openconfig:openconfig-network-instance:network-instances:openconfig-network-instance:network-instance:[a-zA-Z0-9_-]+:openconfig-network-instance:protocols:openconfig-network-instance:protocol:[a-zA-Z0-9_-]+:openconfig-network-instance:global:openconfig-network-instance:afi-safis:openconfig-network-instance:afi-safi$': 'openconfig-network-instance:afi-safi-name',
            ...
            'mdd:openconfig:openconfig-routing-policy:routing-policy:openconfig-routing-policy:defined-sets:openconfig-bgp-policy:bgp-defined-sets:openconfig-bgp-policy:as-path-sets:openconfig-bgp-policy:as-path-set$': 'openconfig-bgp-policy:as-path-set-name',
            'mdd:openconfig:openconfig-routing-policy:routing-policy:openconfig-routing-policy:defined-sets:openconfig-bgp-policy:bgp-defined-sets:openconfig-bgp-policy:community-sets:openconfig-bgp-policy:community-set$': 'openconfig-bgp-policy:community-set-name',
